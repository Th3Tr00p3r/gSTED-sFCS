...
DEVICE_ATTR_DICT = {
    "exc_laser": DeviceAttrs(
        ...
        led_color="blue",
        param_widgets=QtWidgetCollection(
            led_widget=("ledExc", "icon", "main", True),
            switch_widget=("excOnButton", "icon", "main", True),
            model=("excMod", "text", "settings", False),
            trg_src=("excTriggerSrc", "currentText", "settings", False),
            ext_trg_addr=("excTriggerExtAddr", "text", "settings", False),
            int_trg_addr=("excTriggerIntAddr", "text", "settings", False),
            address=("excAddr", "text", "settings", False),
        ),
    ),
    "dep_shutter": DeviceAttrs(
        ...
        log_ref="Shutter",
        param_widgets=QtWidgetCollection(
            led_widget=("ledShutter", "icon", "main", True),
            switch_widget=("depShutterOn", "icon", "main", True),
            address=("depShutterAddr", "text", "settings", False),
        ),
    ),
    "TDC": DeviceAttrs(
        class_name="SimpleDO",
        log_ref="TDC",
        param_widgets=QtWidgetCollection(
            led_widget=("ledTdc", "icon", "main", True),
            address=("TDCaddress", "text", "settings", False),
            data_vrsn=("TDCdataVersion", "text", "settings", False),
            laser_freq_MHz=("TDClaserFreq", "value", "settings", False),
            fpga_freq_MHz=("TDCFPGAFreq", "value", "settings", False),
            tdc_vrsn=("TDCversion", "value", "settings", False),
        ),
    ),
    "dep_laser": DeviceAttrs(
        ...
        led_color="orange",
        param_widgets=QtWidgetCollection(
            led_widget=("ledDep", "icon", "main", True),
            switch_widget=("depEmissionOn", "icon", "main", True),
            model_query=("depModelQuery", "text", "settings", False),
        ),
    ),
    "stage": DeviceAttrs(
        ...
        log_ref="Stage",
        param_widgets=QtWidgetCollection(
            led_widget=("ledStage", "icon", "main", True),
            switch_widget=("stageOn", "icon", "main", True),
            address=("arduinoAddr", "text", "settings", False),
        ),
    ),
    "UM232H": DeviceAttrs(
        class_name="UM232H",
        log_ref="UM232H",
        param_widgets=QtWidgetCollection(
            led_widget=("ledUm232h", "icon", "main", True),
            bit_mode=("um232BitMode", "text", "settings", False),
            timeout_ms=("um232Timeout", "value", "settings", False),
            ltncy_tmr_val=("um232LatencyTimerVal", "value", "settings", False),
            flow_ctrl=("um232FlowControl", "text", "settings", False),
            tx_size=("um232TxSize", "value", "settings", False),
            n_bytes=("um232NumBytes", "value", "settings", False),
        ),
    ),
    "camera": DeviceAttrs(
        class_name="Camera",
        ...
        log_ref="Camera",
        param_widgets=QtWidgetCollection(
            led_widget=("ledCam", "icon", "main", True),
            model=("uc480PlaceHolder", "value", "settings", False),
        ),
    ),
    "scanners": DeviceAttrs(
        ...
        log_ref="Scanners",
        param_widgets=QtWidgetCollection(
            led_widget=("ledScn", "icon", "main", True),
            ao_x_init_vltg=("xAOV", "value", "main", False),
            ao_y_init_vltg=("yAOV", "value", "main", False),
            ao_z_init_vltg=("zAOV", "value", "main", False),
            x_um2V_const=("xConv", "value", "settings", False),
            y_um2V_const=("yConv", "value", "settings", False),
            z_um2V_const=("zConv", "value", "settings", False),
            ai_x_addr=("AIXaddr", "text", "settings", False),
            ai_y_addr=("AIYaddr", "text", "settings", False),
            ai_z_addr=("AIZaddr", "text", "settings", False),
            ai_laser_mon_addr=("AIlaserMonAddr", "text", "settings", False),
            ai_clk_div=("AIclkDiv", "value", "settings", False),
            ai_trg_src=("AItrigSrc", "text", "settings", False),
            ao_x_addr=("AOXaddr", "text", "settings", False),
            ao_y_addr=("AOYaddr", "text", "settings", False),
            ao_z_addr=("AOZaddr", "text", "settings", False),
            ao_int_x_addr=("AOXintAddr", "text", "settings", False),
            ao_int_y_addr=("AOYintAddr", "text", "settings", False),
            ao_int_z_addr=("AOZintAddr", "text", "settings", False),
            ao_dig_trg_src=("AOdigTrigSrc", "text", "settings", False),
            ao_trg_edge=("AOtriggerEdge", "currentText", "settings", False),
            ao_wf_type=("AOwfType", "currentText", "settings", False),
        ),
    ),
    "photon_detector": DeviceAttrs(
        ...
        param_widgets=QtWidgetCollection(
            led_widget=("ledCounter", "icon", "main", True),
            pxl_clk=("counterPixelClockAddress", "text", "settings", False),
            pxl_clk_output=("pixelClockCounterIntOutputAddress", "text", "settings", False),
            trggr=("counterTriggerAddress", "text", "settings", False),
            trggr_armstart_digedge=("counterTriggerArmStartDigEdgeSrc", "text", "settings", False),
            trggr_edge=("counterTriggerEdge", "currentText", "settings", False),
            address=("counterAddress", "text", "settings", False),
            CI_cnt_edges_term=("counterCIcountEdgesTerm", "text", "settings", False),
            CI_dup_prvnt=("counterCIdupCountPrevention", "isChecked", "settings", False),
        ),
    ),
    "pixel_clock": DeviceAttrs(
        ...
        log_ref="Pixel Clock",
        param_widgets=QtWidgetCollection(
            led_widget=("ledPxlClk", "icon", "main", True),
            low_ticks=("pixelClockLowTicks", "value", "settings", False),
            high_ticks=("pixelClockHighTicks", "value", "settings", False),
            cntr_addr=("pixelClockCounterAddress", "text", "settings", False),
            tick_src=("pixelClockSrcOfTicks", "text", "settings", False),
            out_term=("pixelClockOutput", "text", "settings", False),
            out_ext_term=("pixelClockOutputExt", "text", "settings", False),
            freq_MHz=("pixelClockFreq", "value", "settings", False),
        ),
    ),
}
