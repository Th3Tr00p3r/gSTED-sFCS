...
SOL_EXP_ANALYSIS_COLL = QtWidgetCollection(
    ...
    gui_display_resolution=("solExpResolution", None, "main", True),
    # structure factor
    ...
    sigma_sted=("expPropSigmaSted", "QDoubleSpinBox", "main", True),
...
SOL_ANG_SCAN_COLL = QtWidgetCollection(
    ...
    scan_width_um=("maxWidth", "QSpinBox", "main", False),
    max_scan_freq_Hz=("maxScanFreq", "QSpinBox", "settings", False),
