...
class Ui_Camera(object):
    def setupUi(self, Camera):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/camera-photo.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"background-repeat: no-repeat;")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/system-search.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
