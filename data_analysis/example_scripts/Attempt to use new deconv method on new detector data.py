...
# %%
# gated signal:
gated_signal_CF = exp1.confocal.correlate_and_average(
    gate_ns=(3, 15), should_subtract_afterpulse=False, is_verbose=True
)
...
with Plotter(
    ...
    ax.plot(gated_signal_CF.lag, gated_signal_CF.avg_cf_cr, label="Afterpulsed Gated Signal")
    ax.plot(
        lag_signal_old,
